        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="card bg-light mb-3" style="max-width: 18rem;">
              <div class="card-header text-center">Total de Pessoas Cadastradas</div>
                <div class="card-body">
                  <h5 class="card-title text-center">150</h5>
                </div>
          </div><!-- End Sales Card -->
            <div class="card bg-light mb-3 mx-3" style="max-width: 18rem;">
                <div class="card-header text-center">Total de Professores</div>
                  <div class="card-body">
                    <h5 class="card-title text-center">150</h5>
                  </div>
                </div>
