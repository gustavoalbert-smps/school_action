<div class="bg-white rounded-lg shadow-sm p-5">
    ...
    <form class="form" id="registration-form" onsubmit="return formValidationStudent();" action="registerUser.php" method="POST">
        <fieldset>
    ...
    <script>
        ...
        function formValidationStudent() {
            ...
            var classSelect = document.getElementsByName("class")[0].value;
            ...
            if (classSelect  == "default") {
                $('#class-empty').show();
                document.getElementsByName("class").focus();
                return false;
            }
            return true;
        }
